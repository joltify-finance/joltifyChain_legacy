...
const baseEpochInfo: object = { identifier: '', current_epoch: 0, epoch_counting_started: false, current_epoch_start_height: 0 }
...
export const EpochInfo = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6:
          ...
          break
        case 8:
          message.current_epoch_start_height = longToNumber(reader.int64() as Long)
          break
        default:
  ...
  fromJSON(object: any): EpochInfo {
    ...
    if (object.current_epoch_start_time !== undefined && object.current_epoch_start_time !== null) {
      message.current_epoch_start_time = fromJsonTimestamp(object.current_epoch_start_time)
    } else {
    ...
    if (object.current_epoch_start_height !== undefined && object.current_epoch_start_height !== null) {
      message.current_epoch_start_height = Number(object.current_epoch_start_height)
    } else {
  ...
  toJSON(message: EpochInfo): unknown {
    ...
    message.current_epoch_start_time !== undefined &&
      (obj.current_epoch_start_time = message.current_epoch_start_time !== undefined ? message.current_epoch_start_time.toISOString() : null)
    message.epoch_counting_started !== undefined && (obj.epoch_counting_started = message.epoch_counting_started)
    message.current_epoch_start_height !== undefined && (obj.current_epoch_start_height = message.current_epoch_start_height)
    return obj
  },
