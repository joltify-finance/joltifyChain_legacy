...
export const protobufPackage = 'joltify.joltifychain.epochs'
...
export const QueryEpochsInfoResponse = {
  encode(message: QueryEpochsInfoResponse, writer: Writer = Writer.create()): Writer {
...
export const QueryCurrentEpochRequest = {
  encode(message: QueryCurrentEpochRequest, writer: Writer = Writer.create()): Writer {
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryCurrentEpochRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
...
export const QueryCurrentEpochResponse = {
  encode(message: QueryCurrentEpochResponse, writer: Writer = Writer.create()): Writer {
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryCurrentEpochResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
  ...
  toJSON(message: QueryCurrentEpochResponse): unknown {
    const obj: any = {}
    message.current_epoch !== undefined && (obj.current_epoch = message.current_epoch)
    return obj
  },
...
export class QueryClientImpl implements Query {
  ...
  EpochInfos(request: QueryEpochsInfoRequest): Promise<QueryEpochsInfoResponse> {
    ...
    const promise = this.rpc.request('joltify.joltifychain.epochs.Query', 'EpochInfos', data)
    return promise.then((data) => QueryEpochsInfoResponse.decode(new Reader(data)))
  }

  CurrentEpoch(request: QueryCurrentEpochRequest): Promise<QueryCurrentEpochResponse> {
    const data = QueryCurrentEpochRequest.encode(request).finish()
    const promise = this.rpc.request('joltify.joltifychain.epochs.Query', 'CurrentEpoch', data)
    return promise.then((data) => QueryCurrentEpochResponse.decode(new Reader(data)))
  }
}
