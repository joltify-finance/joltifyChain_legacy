...
export const PoolParams = {
  ...
  toJSON(message: PoolParams): unknown {
    ...
    message.smoothWeightChangeParams !== undefined &&
      (obj.smoothWeightChangeParams = message.smoothWeightChangeParams ? SmoothWeightChangeParams.toJSON(message.smoothWeightChangeParams) : undefined)
    return obj
  },
...
const basePool: object = { address: '', id: 0, future_pool_governor: '', totalWeight: '' }
