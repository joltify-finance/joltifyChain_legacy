...
export const QueryEpochProvisionsRequest = {
  encode(_: QueryEpochProvisionsRequest, writer: Writer = Writer.create()): Writer {
    return writer
  },

  decode(input: Reader | Uint8Array, length?: number): QueryEpochProvisionsRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
...
export const QueryEpochProvisionsResponse = {
  encode(message: QueryEpochProvisionsResponse, writer: Writer = Writer.create()): Writer {
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryEpochProvisionsResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
  ...
  toJSON(message: QueryEpochProvisionsResponse): unknown {
    ...
    message.epoch_provisions !== undefined &&
      (obj.epoch_provisions = base64FromBytes(message.epoch_provisions !== undefined ? message.epoch_provisions : new Uint8Array()))
    return obj
  },
...
export class QueryClientImpl implements Query {
  ...
  Params(request: QueryParamsRequest): Promise<QueryParamsResponse> {
    ...
    const promise = this.rpc.request('joltify.joltifychain.mint.v1beta1.Query', 'Params', data)
    return promise.then((data) => QueryParamsResponse.decode(new Reader(data)))
  }

  EpochProvisions(request: QueryEpochProvisionsRequest): Promise<QueryEpochProvisionsResponse> {
    const data = QueryEpochProvisionsRequest.encode(request).finish()
    const promise = this.rpc.request('joltify.joltifychain.mint.v1beta1.Query', 'EpochProvisions', data)
    return promise.then((data) => QueryEpochProvisionsResponse.decode(new Reader(data)))
  }
}
