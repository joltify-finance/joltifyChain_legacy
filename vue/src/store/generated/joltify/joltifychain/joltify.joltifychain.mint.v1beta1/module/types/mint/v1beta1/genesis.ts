...
export const GenesisState = {
  ...
  fromJSON(object: any): GenesisState {
    ...
    if (object.halven_started_epoch !== undefined && object.halven_started_epoch !== null) {
  ...
  toJSON(message: GenesisState): unknown {
    ...
    message.halven_started_epoch !== undefined && (obj.halven_started_epoch = message.halven_started_epoch)
    return obj
  },
