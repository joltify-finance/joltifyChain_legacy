...
export class Api extends HttpClient {
    constructor() {
         ...
         */
        this.queryInvoice = (index, params = {}) => this.request({
         ...
         */
        this.queryPlaceOrderAll = (query, params = {}) => this.request({
         ...
         */
        this.queryPlaceOrder = (index, params = {}) => this.request({
         ...
         */
        this.querySellOrderAll = (query, params = {}) => this.request({
         ...
         */
        this.querySellOrder = (index, params = {}) => this.request({
