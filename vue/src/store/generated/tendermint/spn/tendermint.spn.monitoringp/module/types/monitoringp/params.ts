...
const baseParams: object = { lastBlockHeight: 0, consumerChainID: '', consumerUnbondingPeriod: 0, consumerRevisionHeight: 0 }
...
export const Params = {
  ...
  fromJSON(object: any): Params {
    ...
    if (object.consumerChainID !== undefined && object.consumerChainID !== null) {
      message.consumerChainID = String(object.consumerChainID)
    } else {
      message.consumerChainID = ''
    }
    if (object.consumerConsensusState !== undefined && object.consumerConsensusState !== null) {
      message.consumerConsensusState = ConsensusState.fromJSON(object.consumerConsensusState)
    } else {
      message.consumerConsensusState = undefined
    }
    if (object.consumerUnbondingPeriod !== undefined && object.consumerUnbondingPeriod !== null) {
      message.consumerUnbondingPeriod = Number(object.consumerUnbondingPeriod)
    } else {
      message.consumerUnbondingPeriod = 0
    }
    if (object.consumerRevisionHeight !== undefined && object.consumerRevisionHeight !== null) {
  ...
  toJSON(message: Params): unknown {
    ...
    message.consumerConsensusState !== undefined &&
      (obj.consumerConsensusState = message.consumerConsensusState ? ConsensusState.toJSON(message.consumerConsensusState) : undefined)
    message.consumerUnbondingPeriod !== undefined && (obj.consumerUnbondingPeriod = message.consumerUnbondingPeriod)
    message.consumerRevisionHeight !== undefined && (obj.consumerRevisionHeight = message.consumerRevisionHeight)
    return obj
  },
  ...
  fromPartial(object: DeepPartial<Params>): Params {
    ...
    if (object.consumerConsensusState !== undefined && object.consumerConsensusState !== null) {
      message.consumerConsensusState = ConsensusState.fromPartial(object.consumerConsensusState)
    } else {
      message.consumerConsensusState = undefined
    }
    if (object.consumerUnbondingPeriod !== undefined && object.consumerUnbondingPeriod !== null) {
