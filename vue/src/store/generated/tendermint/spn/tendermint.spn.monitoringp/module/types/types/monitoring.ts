...
export const MonitoringPacketData = {
  encode(message: MonitoringPacketData, writer: Writer = Writer.create()): Writer {
  ...
  fromJSON(object: any): MonitoringPacketData {
    const message = { ...baseMonitoringPacketData } as MonitoringPacketData
    if (object.monitoringPacket !== undefined && object.monitoringPacket !== null) {
      message.monitoringPacket = MonitoringPacket.fromJSON(object.monitoringPacket)
    } else {
  ...
  toJSON(message: MonitoringPacketData): unknown {
    const obj: any = {}
    message.monitoringPacket !== undefined && (obj.monitoringPacket = message.monitoringPacket ? MonitoringPacket.toJSON(message.monitoringPacket) : undefined)
    return obj
  },
  ...
  fromPartial(object: DeepPartial<MonitoringPacketData>): MonitoringPacketData {
    const message = { ...baseMonitoringPacketData } as MonitoringPacketData
    if (object.monitoringPacket !== undefined && object.monitoringPacket !== null) {
      message.monitoringPacket = MonitoringPacket.fromPartial(object.monitoringPacket)
    } else {
      message.monitoringPacket = undefined
    }
    return message
...
export const SignatureCount = {
  ...
  fromJSON(object: any): SignatureCount {
    ...
    if (object.RelativeSignatures !== undefined && object.RelativeSignatures !== null) {
