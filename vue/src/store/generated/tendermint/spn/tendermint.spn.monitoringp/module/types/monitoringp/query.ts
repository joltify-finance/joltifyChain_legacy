...
export const QueryGetConsumerClientIDRequest = {
  encode(_: QueryGetConsumerClientIDRequest, writer: Writer = Writer.create()): Writer {
    return writer
  },

  decode(input: Reader | Uint8Array, length?: number): QueryGetConsumerClientIDRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseQueryGetConsumerClientIDRequest } as QueryGetConsumerClientIDRequest
  ...
  fromPartial(_: DeepPartial<QueryGetConsumerClientIDRequest>): QueryGetConsumerClientIDRequest {
    const message = { ...baseQueryGetConsumerClientIDRequest } as QueryGetConsumerClientIDRequest
    return message
  }
}
...
export const QueryGetConsumerClientIDResponse = {
  encode(message: QueryGetConsumerClientIDResponse, writer: Writer = Writer.create()): Writer {
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryGetConsumerClientIDResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseQueryGetConsumerClientIDResponse } as QueryGetConsumerClientIDResponse
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): QueryGetConsumerClientIDResponse {
    const message = { ...baseQueryGetConsumerClientIDResponse } as QueryGetConsumerClientIDResponse
    if (object.ConsumerClientID !== undefined && object.ConsumerClientID !== null) {
      message.ConsumerClientID = ConsumerClientID.fromJSON(object.ConsumerClientID)
    } else {
  ...
  toJSON(message: QueryGetConsumerClientIDResponse): unknown {
    const obj: any = {}
    message.ConsumerClientID !== undefined && (obj.ConsumerClientID = message.ConsumerClientID ? ConsumerClientID.toJSON(message.ConsumerClientID) : undefined)
    return obj
  },

  fromPartial(object: DeepPartial<QueryGetConsumerClientIDResponse>): QueryGetConsumerClientIDResponse {
    const message = { ...baseQueryGetConsumerClientIDResponse } as QueryGetConsumerClientIDResponse
    if (object.ConsumerClientID !== undefined && object.ConsumerClientID !== null) {
      message.ConsumerClientID = ConsumerClientID.fromPartial(object.ConsumerClientID)
    } else {
      message.ConsumerClientID = undefined
    }
    return message
...
export const QueryGetConnectionChannelIDRequest = {
  encode(_: QueryGetConnectionChannelIDRequest, writer: Writer = Writer.create()): Writer {
    return writer
  },

  decode(input: Reader | Uint8Array, length?: number): QueryGetConnectionChannelIDRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseQueryGetConnectionChannelIDRequest } as QueryGetConnectionChannelIDRequest
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        default:
  ...
  fromPartial(_: DeepPartial<QueryGetConnectionChannelIDRequest>): QueryGetConnectionChannelIDRequest {
    const message = { ...baseQueryGetConnectionChannelIDRequest } as QueryGetConnectionChannelIDRequest
    return message
  }
}
...
export const QueryGetConnectionChannelIDResponse = {
  encode(message: QueryGetConnectionChannelIDResponse, writer: Writer = Writer.create()): Writer {
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryGetConnectionChannelIDResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseQueryGetConnectionChannelIDResponse } as QueryGetConnectionChannelIDResponse
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): QueryGetConnectionChannelIDResponse {
    const message = { ...baseQueryGetConnectionChannelIDResponse } as QueryGetConnectionChannelIDResponse
    if (object.ConnectionChannelID !== undefined && object.ConnectionChannelID !== null) {
      message.ConnectionChannelID = ConnectionChannelID.fromJSON(object.ConnectionChannelID)
    } else {
  ...
  toJSON(message: QueryGetConnectionChannelIDResponse): unknown {
    const obj: any = {}
    message.ConnectionChannelID !== undefined &&
      (obj.ConnectionChannelID = message.ConnectionChannelID ? ConnectionChannelID.toJSON(message.ConnectionChannelID) : undefined)
    return obj
  },

  fromPartial(object: DeepPartial<QueryGetConnectionChannelIDResponse>): QueryGetConnectionChannelIDResponse {
    const message = { ...baseQueryGetConnectionChannelIDResponse } as QueryGetConnectionChannelIDResponse
    if (object.ConnectionChannelID !== undefined && object.ConnectionChannelID !== null) {
      message.ConnectionChannelID = ConnectionChannelID.fromPartial(object.ConnectionChannelID)
    } else {
      message.ConnectionChannelID = undefined
    }
    return message
...
export const QueryGetMonitoringInfoRequest = {
  encode(_: QueryGetMonitoringInfoRequest, writer: Writer = Writer.create()): Writer {
    return writer
  },

  decode(input: Reader | Uint8Array, length?: number): QueryGetMonitoringInfoRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseQueryGetMonitoringInfoRequest } as QueryGetMonitoringInfoRequest
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        default:
  ...
  fromPartial(_: DeepPartial<QueryGetMonitoringInfoRequest>): QueryGetMonitoringInfoRequest {
    const message = { ...baseQueryGetMonitoringInfoRequest } as QueryGetMonitoringInfoRequest
    return message
  }
}
...
export const QueryGetMonitoringInfoResponse = {
  encode(message: QueryGetMonitoringInfoResponse, writer: Writer = Writer.create()): Writer {
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryGetMonitoringInfoResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseQueryGetMonitoringInfoResponse } as QueryGetMonitoringInfoResponse
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  toJSON(message: QueryGetMonitoringInfoResponse): unknown {
    const obj: any = {}
    message.MonitoringInfo !== undefined && (obj.MonitoringInfo = message.MonitoringInfo ? MonitoringInfo.toJSON(message.MonitoringInfo) : undefined)
    return obj
  },

  fromPartial(object: DeepPartial<QueryGetMonitoringInfoResponse>): QueryGetMonitoringInfoResponse {
    const message = { ...baseQueryGetMonitoringInfoResponse } as QueryGetMonitoringInfoResponse
    if (object.MonitoringInfo !== undefined && object.MonitoringInfo !== null) {
...
export class QueryClientImpl implements Query {
  ...
  ConsumerClientID(request: QueryGetConsumerClientIDRequest): Promise<QueryGetConsumerClientIDResponse> {
    ...
    return promise.then((data) => QueryGetConsumerClientIDResponse.decode(new Reader(data)))
  }
  ...
  ConnectionChannelID(request: QueryGetConnectionChannelIDRequest): Promise<QueryGetConnectionChannelIDResponse> {
    ...
    return promise.then((data) => QueryGetConnectionChannelIDResponse.decode(new Reader(data)))
  }
  ...
  MonitoringInfo(request: QueryGetMonitoringInfoRequest): Promise<QueryGetMonitoringInfoResponse> {
    ...
    return promise.then((data) => QueryGetMonitoringInfoResponse.decode(new Reader(data)))
  }
