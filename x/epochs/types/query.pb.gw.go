...
var (
	pattern_Query_EpochInfos_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"joltify", "joltifychain", "epochs"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_CurrentEpoch_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"joltify", "joltifychain", "epochs", "current_epoch"}, "", runtime.AssumeColonVerbOpt(true)))
)
